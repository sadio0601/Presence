...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Générer les dates des mardis et samedis du mois en cours
            ...
            function generatePDF() {
                ...
                const today = new Date();
                doc.setFontSize(12);
                doc.text(`Généré le: ${formatDate(today)}`, 105, 25, { align: 'center' });
                
                // Tableau des données
                const tableColumn = ["Nom", "Prénom", "Prés. Mardi", "Abs. Mardi", "Prés. Samedi", "Abs. Samedi", "Total Prés.", "Total Abs."];
                const tableRows = [];
                ...
                // Enregistrer le PDF
                doc.save(`rapport_presences_${today.getFullYear()}_${today.getMonth()+1}.pdf`);
            }
